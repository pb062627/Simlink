...
namespace muWrapper
{
    public partial class WndSample : Form
    {
      ...
      private muMathParser.Parser m_parser;
      private muMathParser.Parser[] m_parserImg = new muMathParser.Parser[3];
      ...
      public WndSample()
      {
        ...
        try
        {
          ...
          lbVersion.Text = String.Format("muMathParser V{0}", m_parser.GetVersion());
          ...
          //m_parser.DefinePostfixOprt("m", new muMathParser.Parser.Fun1Delegate(milli));
          m_parser.DefineInfixOprt("!", new muMathParser.Parser.Fun1Delegate(not), muMathParser.Parser.EPrec.prLOGIC);
...
//          DumpException(exc);
      ...
      class CalcState
      {
        public CalcState(ManualResetEvent reset, muMathParser.Parser parser, int offset)
        {
            Reset = reset;
            Parser = parser;
            Offset = offset;
        ...
        public muMathParser.Parser Parser { get; set; }
      ...
      private void CalculateSingleThread()
      {
        ...
        ParserVariable x = new ParserVariable(0);
        ParserVariable y = new ParserVariable(0);
        foreach (muMathParser.Parser p in m_parserImg)
        {
          p.DefineVar("x", x);
          p.DefineVar("y", y);
        }
      ...
      private void CalculateMultiReturn()
      {
        ...
        ParserVariable x = new ParserVariable(0);
        ParserVariable y = new ParserVariable(0);
        muMathParser.Parser p = new muMathParser.Parser(muMathParser.Parser.EBaseType.tpDOUBLE);
