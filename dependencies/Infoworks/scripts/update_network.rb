...
update_settings_file = 'C:\\simlink\\settings\\update.json'		
...
begin
	...
	update_settings = JSON.parse(File.read(update_settings_file))
rescue 
	puts "FAIL:SETTINGS"
end
puts "got here...."
# retrieve the CSV location for updating the file
csv_for_update =  update_settings['update_csv']      #"c:\\simlink\\bin\\update.csv"
puts csv_for_update
